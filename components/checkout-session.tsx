...
export function CheckoutSession({ customerDetails }: Props) {
  ...
  return (
    <>
      <CheckCheck className="mx-auto h-10 w-10 text-[#606C38]" />
      <h1 className="mt-4 text-3xl font-bold tracking-tight text-[#606C38] sm:text-5xl">
        Order Successful!
      </h1>
      ...
      <p className="mt-8">
        ...
        <span className="mx-1 font-extrabold text-accent">
